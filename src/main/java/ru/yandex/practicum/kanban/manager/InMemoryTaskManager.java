...
*/
    ...
    public void deleteAllTask() {
        //Задачи нужно удалить и из priorityTask,
        // аналогично для сабтасок и сабтасок при удалении эпика.
        if (!tasksMap.isEmpty()) {
